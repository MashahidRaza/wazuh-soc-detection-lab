...
The alert was investigated rather than immediately classified as malware.

The investigation identified:

- `dllhost.exe` running from `C:\Windows\SysWOW64\`
- Microsoft Corporation as the file publisher
- File description: `COM Surrogate`
- A legitimate Windows executable name and path
- A SHA256 hash collected from the Sysmon telemetry
- A COM process identifier supplied through the command line
- High integrity level
- Parent process information requiring additional investigation

The available evidence did not establish that the executable itself was malicious.

### Verdict

**Suspicious activity investigated — no confirmed malware identified.**

The alert demonstrates why SIEM alerts should be treated as investigation starting points rather than automatic malware verdicts.
